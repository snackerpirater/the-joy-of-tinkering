...
import com.snackpirate.joy_of_tinkering.data.fluids.JOTFluidEffects;
import com.snackpirate.joy_of_tinkering.data.materials.*;
import com.snackpirate.joy_of_tinkering.data.fluids.JOTFluidTextures;
import com.snackpirate.joy_of_tinkering.data.recipes.JOTRecipes;
...
//		Config.items.forEach((item) -> LOGGER.info("ITEM >> {}", item.toString()));
	...
	public static void genData(GatherDataEvent event) {
		...
		gen.addProvider(server, new JOTFluidEffects(output));
