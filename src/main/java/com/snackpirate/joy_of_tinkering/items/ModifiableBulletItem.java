...
public class ModifiableBulletItem extends Item implements IModifiableDisplay {
	...
	public ModifiableBulletItem(Properties props, ToolDefinition toolDefinition) {
		super(props);
...
//			ModifiableBullet bullet = new ModifiableBullet(level, player);
//			IToolStackView tool = bullet.onCreate(stack, player);
//			float velocity = ConditionalStatModifierHook.getModifiedStat(tool, player, ToolStats.VELOCITY);
//			bullet.shootFromRotation(player, player.getXRot(), player.getYRot(), 0.0F, velocity, 1.0F);
