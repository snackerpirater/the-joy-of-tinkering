...
public class JOTMaterialIds {
	...
	public static final MaterialVariantId twistedShimmervine = MaterialVariantId.create(shimmervine, "twisted");
	public static final MaterialVariantId crimsonShimmervine = MaterialVariantId.create(shimmervine, "crimson");
