...
//		add("item.tconstruct.slime_helmet.material.tconstruct.enderslime", "Enderslime Slimeskull");
		...
		addModifier(JOTModifierIds.greedy, "Greed", "Biblical levels of greed", "Increases the chance for killed mobs to drop their equipment");
		add("modifier.joy_of_tinkering.greedy.2", "Greed & Experienced");
	...
	public void addMaterialVariant(MaterialVariantId variant, String name) {
		add("material.joy_of_tinkering." + variant.getId().getPath() + "." + variant.getVariant(), name);
	}
