...
public class JOTItemTags extends ItemTagsProvider {
	...
	protected void addTags(HolderLookup.Provider pProvider) {
		...
		addToolTags(JOTItems.ROCKPUNCHERS, MULTIPART_TOOL,  DURABILITY, BONUS_SLOTS, CHESTPLATES, WORN_ARMOR, TRIM, ANCIENT_TOOLS, TRADER_TOOLS);
		addToolTags(JOTItems.LAVA_LOAFERS, SINGLEPART_TOOL, DURABILITY, BONUS_SLOTS, BOOTS,       WORN_ARMOR, TRIM, ANCIENT_TOOLS, TRADER_TOOLS);
		...
		addToolTags(JOTItems.morningStar, MULTIPART_TOOL, DURABILITY, BONUS_SLOTS, MELEE_PRIMARY, INTERACTABLE_RIGHT, SMALL_TOOLS, HARVEST_PRIMARY);
		addToolTags(JOTItems.greatmace, MULTIPART_TOOL, DURABILITY, BONUS_SLOTS, MELEE_PRIMARY, INTERACTABLE_RIGHT, BROAD_TOOLS, AOE, HARVEST_PRIMARY);
