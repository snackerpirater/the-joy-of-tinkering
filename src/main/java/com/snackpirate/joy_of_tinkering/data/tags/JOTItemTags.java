...
public class JOTItemTags extends ItemTagsProvider {
	...
	protected void addTags(HolderLookup.Provider pProvider) {
		...
		tag(PROPELLANTS).add(Items.GUNPOWDER, Items.GLOWSTONE_DUST, Items.SUGAR, Items.BONE_MEAL, Items.POWDER_SNOW_BUCKET, Items.PRISMARINE_CRYSTALS, Items.BLAZE_POWDER);
	}
